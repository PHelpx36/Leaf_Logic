...
import com.fsa.leaf_logic.databinding.FragmentCompletedNotificationsBinding
...
class CompletedFragment : Fragment(R.layout.fragment_completed_notifications) {

    private lateinit var binding: FragmentCompletedNotificationsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCompletedNotificationsBinding.inflate(inflater, container, false)
        return binding.root
    }
            ...
            try {
                ...
                withContext(Dispatchers.Main) {
                    if (response.isNotEmpty()) {
                        ...
                        notificationAdapter.updateNotifications(response)
